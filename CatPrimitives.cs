    ...
    public class Primitives {
        ...
        */
        ...
        public class ToInt : PrimitiveFunction {
            ...
            public override void Eval( Executor exec ) {
                Object o = exec.Pop();
                if (o is int) { exec.Push( o ); } else if (o is double) { exec.Push( (int)(Double)o ); } else if (o is char) { exec.Push( (int)(Char)o ); } else if (o is string) { exec.Push( Int32.Parse( o as String ) ); } else if (o is bool) { exec.Push( (Boolean)o ? 1 : 0 ); } else if (o is Bit) { exec.Push( ((Bit)(o)).m ? 1 : 0 ); } else if (o is Stack) { exec.Push( (o as Stack).Count ); } else { exec.PushInt( 0 ); }
            }
        }
        ...
        public class ToBool : PrimitiveFunction {
            ...
            public override void Eval( Executor exec ) {
                Object o = exec.Pop();
                if (o is int) { exec.Push( o ); } else if (o is double) { exec.Push( (Double)o != 0.0 ); } else if (o is char) { exec.Push( (int)(Char)o != 0 ); } else if (o is string) { exec.Push( Boolean.Parse( o as String ) ); } else if (o is bool) { exec.Push( o ); } else if (o is Bit) { exec.Push( ((Bit)(o)).m ); } else if (o is Stack) { exec.Push( (o as Stack).Count == 0 ); } else { exec.PushBool( false ); }
            }
        }
        #endregion
